...
class Report extends React.Component {
  ...
  handlereport = ()=>{
    ...
    const repObj = {
       ...
       axios({
        url:'http://localhost:2021/frauds',
        method: 'POST',
  ...
  render() {
    return (
      <div>
                        ...
                        <h3 className="Acc-name">Report a Fraud</h3>
                            ...
                            <textarea type="text" placeholder="enter your Problem" className="form-control text-areaH" style={{ padding: '5px', }} onChange={(event) => this.handleInputChange(event, 'message')} />
                            <button className="btn btn-danger mt-3"  onClick={this.handlereport}>Submit</button> </div>
                        <div class="col col-lg-4"> </div>
