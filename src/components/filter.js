                    ...
                    <div className="row text-start">
                        <div className="col-lg-4 col-md-6 col-sm-6 ">
                            ...
                            <div id="filter" className="collaps show">
                                ...
                                <div className="cost">Cost For Two
                                    <div> <input type="radio" className="cost-two " value="1" name="cost"  onChange={() => this.handleCostChange(1, 500)}/>
                                        <label className="c-leb ">Less than &#8377;500
                                        </label>
                                    </div>
                                    <div> <input type="radio" className="cost-two pt-1" value="2" name="cost" onChange={() => this.handleCostChange(500, 1000)} />
                                        <label className="c-leb pt-1">&#8377; 500 to &#8377;1000
                                        </label>
                                    </div>
                                    <div> <input type="radio" className="cost-two pt-1" value="3" name="cost"  onChange={() => this.handleCostChange(1000, 1500)}/>
                                        <label className="c-leb pt-1"> &#8377; 1000 to &#8377;1500
                                        </label>
                                    </div>
                                    <div> <input type="radio" className="cost-two pt-1" value="4" name="cost" onChange={() => this.handleCostChange(1500, 2000)} />
                                        <label className="c-leb pt-1">&#8377;1500 to &#8377;2000
                                        </label>
                                    </div>
                                    <div> <input type="radio" className="cost-two pt-1" value="5" name="cost" onChange={() => this.handleCostChange(2000, 50000)} />
                        ...
                        <div className="col-lg-8 col-md-6 col-sm-6 mt-1 g-0 ">
                            {restaurants.length > 0 ? restaurants.map((item, index) => {
                                return <div className="col-lg-12 col-md-6 col-sm-6 g-0 shadowF" key={index} onClick={() => this.handleNavigate(item._id)}>
                            ...
                            }) :<div className="col-lg-12 col-md-6 col-sm-6 g-0 shadowF ">
